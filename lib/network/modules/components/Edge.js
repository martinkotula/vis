...
class Edge {
  ...
  static parseOptions(parentOptions, newOptions, allowDeletion = false, globalOptions = {}) {
    var fields = [
      ...
      'value',
      'width',
	  'arrowFrom', //Allatus - Data Model diagram
	  'arrowTo'
    ];
  ...
  drawArrows(ctx, viaNode) {
	...
	if (this.options.arrowFrom && this.options.arrowFrom.crowsFeet   === true) {this.edgeType.drawCrowsFeet(ctx,'from', 	viaNode, this.selected, this.hover);}
  }
